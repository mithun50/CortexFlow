...
export const BUILT_IN_TEMPLATES = [
    {
        ...
        category: 'bug-fix',
        tasks: [
            { title: 'Reproduce the bug', description: 'Create reliable reproduction steps', priority: 1, dependencies: [] },
            { title: 'Investigate root cause', description: 'Analyze code to find the source of the bug', priority: 1, dependencies: ['Reproduce the bug'] },
            { title: 'Implement fix', description: 'Write the code fix for the identified issue', priority: 1, dependencies: ['Investigate root cause'] },
            { title: 'Write tests', description: 'Add tests to prevent regression', priority: 2, dependencies: ['Implement fix'] },
            { title: 'Update documentation', description: 'Document the fix and any behavior changes', priority: 3, dependencies: ['Implement fix'] },
        ],
    ...
    },
    {
        ...
        category: 'feature',
        tasks: [
            { title: 'Design feature', description: 'Create technical design and architecture', priority: 1, dependencies: [] },
            { title: 'Implement core functionality', description: 'Build the main feature logic', priority: 1, dependencies: ['Design feature'] },
            { title: 'Add UI/API layer', description: 'Create user-facing interface or API endpoints', priority: 2, dependencies: ['Implement core functionality'] },
            { title: 'Write unit tests', description: 'Add comprehensive unit test coverage', priority: 2, dependencies: ['Implement core functionality'] },
            { title: 'Write integration tests', description: 'Add integration and e2e tests', priority: 2, dependencies: ['Add UI/API layer'] },
            { title: 'Code review', description: 'Review code for quality and best practices', priority: 2, dependencies: ['Write unit tests'] },
            { title: 'Update documentation', description: 'Document the new feature', priority: 3, dependencies: ['Code review'] },
        ],
    ...
    },
    {
        ...
        category: 'refactor',
        tasks: [
            { title: 'Analyze current code', description: 'Understand existing implementation and pain points', priority: 1, dependencies: [] },
            { title: 'Ensure test coverage', description: 'Add tests if missing to catch regressions', priority: 1, dependencies: ['Analyze current code'] },
            { title: 'Plan refactoring steps', description: 'Break down refactoring into safe incremental changes', priority: 1, dependencies: ['Ensure test coverage'] },
            { title: 'Execute refactoring', description: 'Implement the planned changes', priority: 1, dependencies: ['Plan refactoring steps'] },
            { title: 'Run all tests', description: 'Verify no regressions introduced', priority: 1, dependencies: ['Execute refactoring'] },
            { title: 'Performance validation', description: 'Ensure performance is not degraded', priority: 2, dependencies: ['Run all tests'] },
        ],
        defaultPhase: Phase.PLANNING,
    ...
    },
    {
        ...
        category: 'review',
        tasks: [
            { title: 'Security review', description: 'Check for security vulnerabilities and issues', priority: 1, dependencies: [] },
            { title: 'Code quality review', description: 'Review code style, patterns, and best practices', priority: 2, dependencies: [] },
            { title: 'Performance review', description: 'Identify potential performance issues', priority: 2, dependencies: [] },
            { title: 'Test coverage review', description: 'Verify adequate test coverage exists', priority: 2, dependencies: [] },
            { title: 'Documentation review', description: 'Check documentation accuracy and completeness', priority: 3, dependencies: [] },
            { title: 'Compile findings', description: 'Summarize all findings and recommendations', priority: 1, dependencies: ['Security review', 'Code quality review', 'Performance review'] },
        ],
